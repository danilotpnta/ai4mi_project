...
class nnUNetTrainer(object):
    ...
    def get_dataloaders(self):
        ...
        # training pipeline
        # print("deep_supervision_scales:", deep_supervision_scales)
        # print("rotation_for_DA:", rotation_for_DA)
        # print("do_dummy_2d_data_aug:", do_dummy_2d_data_aug)
        # print("initial_patch_size:", initial_patch_size)

        # print("patch_size:", patch_size)
        # print("mirror_axes:", mirror_axes)
        # print("use_mask_for_norm:", self.configuration_manager.use_mask_for_norm)
        # print("is_cascaded:", self.is_cascaded)
        # print("foreground_labels:", self.label_manager.foreground_labels)
        # print("regions:", self.label_manager.foreground_regions if self.label_manager.has_regions else None)
        # print("ignore_label:", self.label_manager.ignore_label)
